...
test.beforeEach(async ({ page }) => {
  ...
  await expect(
    page.getByRole("link", { name: "PinasPeaks Logo" })
  ).toBeVisible();
  await page.screenshot({
    path: "screenshots/profile-page_navigate-to-url_loaded-visible_pass.png",
  });
...
// test("Verify if the Profile page of Ivey is loading successfully", async ({ page }) => {
